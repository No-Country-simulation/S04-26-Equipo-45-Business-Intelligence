...
*   **Orquestación y ETL:** `n8n` – Automatización del flujo de datos mensual y limpieza de registros mediante lógica personalizada en nodos y JavaScript.
...
*   **Visualización y Analítica:** `Power BI Desktop & Service` – Modelado de datos (Esquema en Estrella) y cálculo dinámico de KPIs de Recursos Humanos mediante lenguaje DAX.
